...
import {fetchPosts, getPostComments, updatePost} from '../../actions/actions'
                ...
                <form onSubmit={this.editPost}>
                    ...
                    <ul className="form-ul">
                        ...
                        <li>
                            ...
                            <textarea defaultValue={post.body} name="body" id="field5"
...
export default connect(mapStateToProps, {fetchPosts, updatePost, getPostComments})(EditPostForm)
